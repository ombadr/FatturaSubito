...
namespace FatturaSubito.Controllers
{
    public class PreventiviController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (utenteLoggato != null)
            {
                var documenti = db.Documento
                    ...
                    .Where(d => d.UtenteId == utenteLoggato.UtenteId && d.Tipo == TipoDocumento.Preventivo && d.Cestinato == false)
                    .ToList();
        ...
        public ActionResult ScaricaPdf(int id)
        {
            ...
            return new Rotativa.ViewAsPdf("PreventivoPdf", viewModel)
            {
                FileName = $"Preventivo_{documento.Numero}.pdf"
            };
        }
        ...
        private void InviaEmailConPdf(int id, string emailDestinatario, string emailMittente)
        {
            ...
            var pdf = new Rotativa.ViewAsPdf("PreventivoPdf", viewModel)
            {
            ...
            using (var messaggio = new MailMessage())
            {
                ...
                messaggio.Subject = "Il tuo preventivo";
                messaggio.Body = "Ecco il tuo preventivo.";
                messaggio.Attachments.Add(new Attachment(new MemoryStream(binarioPdf), "Preventivo.pdf"));
