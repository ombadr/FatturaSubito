...
{
    public class DocumentiTrasportoController : Controller
    {
        ...
        public string GetStatoFatturaDisplayString(StatoBollaDiTrasporto stato)
        {
            switch (stato)
            {
                case StatoBollaDiTrasporto.Spedito:
                    return "Spedito";
                case StatoBollaDiTrasporto.Ricevuto:
                    return "Ricevuto";
                default:
        ...
        public ActionResult Index()
        {
            ...
            if (utenteLoggato != null)
            {
                var documenti = db.Documento
                    ...
                    .Where(d => d.UtenteId == utenteLoggato.UtenteId && d.Tipo == TipoDocumento.BollaDiTrasporto && d.Cestinato == false)
                    .ToList();
                ...
                var documentiViewModel = documenti.Select(d => new DocumentoViewModel
                {
                    ...
                    Stato = GetStatoFatturaDisplayString((StatoBollaDiTrasporto)d.Stato)
                }).ToList();
        ...
        public ActionResult Aggiungi()
        {
            ...
            if (utenteLoggato != null)
            {
                var viewModel = new FatturaViewModel
                {
                    ...
                    {
                        Tipo = TipoDocumento.BollaDiTrasporto
                    },
        ...
        public ActionResult Modifica(int id)
        {
            ...
            ViewBag.StatoFatturaSelectList = Enum.GetValues(typeof(StatoBollaDiTrasporto))
                    .Cast<StatoBollaDiTrasporto>()
        ...
        public ActionResult Modifica(FatturaViewModel model, string RigheEliminate)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (documentoDb.UtenteId != utenteLoggato.UtenteId)
                {
                    return new HttpStatusCodeResult(HttpStatusCode.Forbidden);
        ...
        public ActionResult ScaricaPdf(int id)
        {
            ...
            return new Rotativa.ViewAsPdf("DocumentoTrasportoPdf", viewModel)
            {
                FileName = $"Documento_Trasporto_{documento.Numero}.pdf",
        ...
        private void InviaEmailConPdf(int id, string emailDestinatario, string emailMittente)
        {
            ...
            var pdf = new Rotativa.ViewAsPdf("DocumentoTrasportoPdf", viewModel)
            {
                FileName = "DDT.pdf"
            };
            ...
            using (var messaggio = new MailMessage())
            {
                ...
                messaggio.Subject = "Il tuo documento di trasporto";
                messaggio.Body = "Ecco il tuo documento di trasporto.";
                messaggio.Attachments.Add(new Attachment(new MemoryStream(binarioPdf), "DDT.pdf"));
                ...
                using (var smtpClient = new SmtpClient())
                {
                    ...
                    smtpClient.Credentials = new NetworkCredential("", ""); // mailgun credentials
